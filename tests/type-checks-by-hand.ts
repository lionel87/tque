...
(async () => {
    ...
    series(function ({ a, b }) { }, function ({ c }) {})({ d: 1 });

    type ABCD = { a: string; b: number; c: boolean; d: number };
    series<Partial<ABCD>>(function ({ a, b }) { }, function ({ c }) {})({ d: 1 });
    ...
    series<Partial<{ x: string }>>(function ({ a, b }) { }, function ({ c }) {})({ d: 1 });
    series<ABCD>(function ({ a, y }) { }, function ({ z }) {})({ d: 1 });
